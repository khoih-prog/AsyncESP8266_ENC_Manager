...
#ifndef AsyncESP8266_ENC_Manager_hpp
#define AsyncESP8266_ENC_Manager_hpp

#if !( defined(ESP8266) )
  #error This code is intended to run on the (ESP8266 + ENC28J60) platform! Please check your Tools->Board setting.
#endif

////////////////////////////////////////////////////

#define ASYNC_ESP8266_ENC_MANAGER_VERSION           "AsyncESP8266_ENC_Manager v1.0.0"

#define ASYNC_ESP8266_ENC_MANAGER_VERSION_MAJOR     1
#define ASYNC_ESP8266_ENC_MANAGER_VERSION_MINOR     0
#define ASYNC_ESP8266_ENC_MANAGER_VERSION_PATCH     0

#define ASYNC_ESP8266_ENC_MANAGER_VERSION_INT       1000000
...
#include "AsyncESP8266_ENC_Manager_Debug.h"
...
class ESPAsync_EMParameter 
{
  ...
  private:
    ...
    friend class AsyncESP8266_ENC_Manager;
};
...
class AsyncESP8266_ENC_Manager
{
  public:

    AsyncESP8266_ENC_Manager(AsyncWebServer * webserver, AsyncDNSServer *dnsserver, const char *iHostname = "");
...
#endif    // AsyncESP8266_ENC_Manager_hpp
