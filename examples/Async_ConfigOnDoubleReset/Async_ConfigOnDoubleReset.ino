...
#if !( defined(ESP8266) )
  #error This code is intended to run on the (ESP8266 + LwIP ENC28J60J60) platform! Please check your Tools->Board setting.
#endif
...
void setup()
{
  ...
  AsyncESP8266_ENC_Manager AsyncESP8266_ENC_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
